  ...
  module Filters
    ...
    def category_links(categories)
      ...
      when 1
        ...
        "#{categories[0...-1].join(', ').capitalize}, #{categories[-1]}"
      end
    end
    ...
    def category_list(categories)
      ...
      categories = categories.keys.sort!.map do |item|
    ...
    def category_link(category)
      dir = @context.registers[:site].config['category_dir']
      "<a class='category' href='#{dir}#{category.gsub(/_|\P{Word}/, '-').gsub(/-{2,}/, '-').downcase}/'>#{category.capitalize}</a>"
    end
